...
# New blog premiere (and in React, Next and Markdown)
...
so I considered this project as the perfect point to start.
...
your documentation and I think it fits perfectly with what I need.

I explain why.

## What technologies were you looking for and why?
...
It is ideal because os design to cloning the code, and it has a very clean base, with several features that I want:
...
Like any React component we can "lay out" our content using JSX.
...
If later I manage to resolve this point, I will do the update in the post.
